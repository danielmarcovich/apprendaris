!(function (t) {
    ...
    h.timeago = function (t) {
        return t instanceof Date ? r(t) : r("string" == typeof t ? h.timeago.parse(t) : "number" == typeof t ? new Date(t) : h.timeago.datetime(t));
    };
    var i = h.timeago;
    h.extend(h.timeago, {
        settings: {
        ...
        inWords: function (n) {
            ...
            var r = this.settings.strings,
                t = r.prefixAgo,
                e = r.suffixAgo;
            if ((this.settings.allowFuture && n < 0 && ((t = r.prefixFromNow), (e = r.suffixFromNow)), !this.settings.allowPast && 0 <= n)) return this.settings.strings.inPast;
            var i = Math.abs(n) / 1e3,
                a = i / 60,
                o = a / 60,
                s = o / 24,
                u = s / 365;
            function m(t, e) {
                var i = h.isFunction(t) ? t(e, n) : t,
                    a = (r.numbers && r.numbers[e]) || e;
                return i.replace(/%d/i, a);
            }
            var l =
                    (i < 45 && m(r.seconds, Math.round(i))) ||
                    (i < 90 && m(r.minute, 1)) ||
                    (a < 45 && m(r.minutes, Math.round(a))) ||
                    (a < 90 && m(r.hour, 1)) ||
                    (o < 24 && m(r.hours, Math.round(o))) ||
                    (o < 42 && m(r.day, 1)) ||
                    (s < 30 && m(r.days, Math.round(s))) ||
                    (s < 45 && m(r.month, 1)) ||
                    (s < 365 && m(r.months, Math.round(s / 30))) ||
                    (u < 1.5 && m(r.year, 1)) ||
                    m(r.years, Math.round(u)),
                d = r.wordSeparator || "";
            return void 0 === r.wordSeparator && (d = " "), h.trim([t, l, e].join(d));
        },
        parse: function (t) {
            var e = h.trim(t);
    ...
    var a = {
        ...
        update: function (t) {
            ...
            h(this).data("timeago", { datetime: e }), i.settings.localeTitle && h(this).attr("title", e.toLocaleString()), n.apply(this);
        },
        updateFromDOM: function () {
            h(this).data("timeago", { datetime: i.parse(i.isTime(this) ? h(this).attr("datetime") : h(this).attr("title")) }), n.apply(this);
        },
        dispose: function () {
    ...
    function n() {
        ...
        return isNaN(e.datetime) || (0 === t.cutoff || Math.abs(o(e.datetime)) < t.cutoff ? h(this).text(r(e.datetime)) : 0 < h(this).attr("title").length && h(this).text(h(this).attr("title"))), this;
    }
    function r(t) {
        return i.inWords(o(t));
    }
    function o(t) {
